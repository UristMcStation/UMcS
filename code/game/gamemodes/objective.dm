...
*/
		"the Championship Belt!" = /obj/item/weapon/storage/belt/champion,
		"an ID console circuit board" = /obj/item/weapon/circuitboard/card,
		"a Teleporter circuit board" = /obj/item/weapon/circuitboard/teleporter,
